	...
	private class OpenFileMenuItemSelectionListener extends SelectionAdapter {
		...
		public void widgetSelected(SelectionEvent e) {
			...
			try {
				...
				String[] file_points = filedata.split("\\n");
				
				//Loop through the lines in filedata and insert into ArrayLisr
				for(String file_point : file_points) {
					String[] coordinates = file_point.split(",");
