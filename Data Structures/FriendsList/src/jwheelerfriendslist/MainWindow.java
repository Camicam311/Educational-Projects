...
public class MainWindow {
	...
	protected void createContents() {
		...
		window = new Composite(shell, SWT.NONE);
		window.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true, true, 1, 1));
		
		Label firstNameLabel = new Label(window, SWT.NONE);
		firstNameLabel.setBounds(10, 10, 82, 15);
		firstNameLabel.setText("First Name");
		
		Label lastNameLabel = new Label(window, SWT.NONE);
		lastNameLabel.setBounds(10, 53, 82, 15);
		lastNameLabel.setText("Last Name");
		
		Label friendsLabel = new Label(window, SWT.NONE);
		friendsLabel.setBounds(10, 100, 55, 15);
		friendsLabel.setText("Friends");
		
		firstNameText = new Text(window, SWT.BORDER);
		firstNameText.setBounds(98, 7, 190, 21);
		
		lastNameText = new Text(window, SWT.BORDER);
		lastNameText.setBounds(98, 50, 190, 21);
		
		Button addButton = new Button(window, SWT.NONE);
		addButton.addSelectionListener(new AddButtonSelectionListener());
		addButton.setBounds(294, 46, 75, 25);
		addButton.setText("Add");
		
		friendsListView = new List(window, SWT.BORDER);
		friendsListView.addSelectionListener(new FriendsListViewSelectionListener());
		friendsListView.setBounds(98, 100, 190, 182);
	...
	private class FriendsListViewSelectionListener extends SelectionAdapter {
		@Override
		public void widgetSelected(SelectionEvent e) {
			int[] selectedIndex = friendsListView.getSelectionIndices();
